...
public interface OnetimeTokensMapper {
  ...
  /**
   * This method was generated by MyBatis Generator. This method corresponds to the database table onetime_tokens
   * @mbg.generated
   */
  @Delete({"delete from onetime_tokens", "where id = #{id,jdbcType=INTEGER}"})
   ...
   * @mbg.generated
   */
  @Insert({"insert into onetime_tokens (id, pre_entry_id, ", "token, limited_date, ",
   ...
   * @mbg.generated
   */
  @Select({"select", "id, pre_entry_id, token, limited_date, create_date, update_date",
      "from onetime_tokens", "where id = #{id,jdbcType=INTEGER}"})
   ...
   * @mbg.generated
   */
  @Update({"update onetime_tokens", "set pre_entry_id = #{preEntryId,jdbcType=INTEGER},",
      "token = #{token,jdbcType=VARCHAR},", "limited_date = #{limitedDate,jdbcType=TIMESTAMP},",
