...
public interface PreEntriesMapper {
     ...
     * This method corresponds to the database table pre_entries
     *
     * @mbg.generated
     */
    @Delete({
        "delete from pre_entries",
     ...
     */
    @Insert({
        "insert into pre_entries (id, tournament_id, ",
        "team_name, representive_name, ",
    ...
    @Select({
        "select",
        "id, tournament_id, team_name, representive_name, email, phone, create_date, ",
        "update_date",
        "from pre_entries",
        "where id = #{id,jdbcType=INTEGER}"
    })
